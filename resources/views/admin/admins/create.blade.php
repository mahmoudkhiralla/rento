...
@section('content')
    <div class="container-fluid px-4 py-4">
        <div class="page-header mb-4 d-flex justify-content-between align-items-center">
            <div>
                <h1 class="page-title">إضافة مشرف جديد</h1>
                <p class="page-subtitle">قم بإدخال بيانات المشرف الجديد وحفظها في النظام</p>
            </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control modern-input @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="أدخل الاسم الكامل">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control modern-input @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="example@mail.com">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" class="form-control modern-input @error('phone') is-invalid @enderror" value="{{ old('phone') }}" placeholder="+218 XX XXX XXXX">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="password-input-wrapper">
                                    <input type="password" name="password" class="form-control modern-input @error('password') is-invalid @enderror" placeholder="••••••••">
                                    <span class="password-toggle"><i class="fas fa-eye"></i></span>
                                </div>
                                @error('password')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror
                                <small class="text-muted">يجب ألا تقل كلمة المرور عن 8 أحرف.</small>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
